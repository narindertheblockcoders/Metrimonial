          ...
          <div className="approve-top-header">
              <div className="self-main-head" id="self-main-head">
                <h3 className="w-50">Profile edit</h3>
                       ...
                       {/* <h3>Approved by</h3> */}
                            <button className="button sub-admin-btn" type="submit" onClick={formSubmitHandler} >
                            Save  </button>    
                     </div>
              ...
              <div className="left-main-box" id="left-main-box">
                ...
                <div className="box-text">
                  <div className="box-text-one">
                    <input type="text" className="editDetails-input mb-4 w-50" value={name} onChange={(e)=>setName(e.target.value)}/>
                    {/* <h2>{name}</h2> */}
                    <div className="flex-box-one">
                      <ul>
                        <li>Age</li>
                        <li>
                        <input type="text" className="editDetails-input" value={age} onChange={(e)=>setAge(e.target.value)}/>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="flex-box-one">
                      <ul>
                        <li>Gender</li>
                        <li>
                        <input type="text" className="editDetails-input" value={gender} onChange={(e)=>setGender(e.target.value)}/>
                        </li>
                      </ul>
                    </div>
                    <div className="flex-box-one">
                      <ul>
                        <li>Profession</li>
                        <li>
                        <input type="text" className="editDetails-input" value={profession} onChange={(e)=>setProfession(e.target.value)}/>
                        </li>
                      </ul>
                    </div>
                    <div className="flex-box-one">
                      <ul>
                        ...
                        <li>
                          <b>
                          <input type="text" className="editDetails-input" value={city + state + country}/> 
                          </b>
                    ...
                    <div className="flex-box-one">
                      <ul>
                        ...
                        <li>
                          <b>
                          <input type="text" className="editDetails-input" value={degree} onChange={(e)=>setDegree(e.target.value)} /> </b>{" "}
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="flex-box-one">
                      <ul>
                        ...
                        <li>
                          <b>
                          <input type="text" className="editDetails-input" value={work} onChange={(e)=>setWork(e.target.value)}/> </b>{" "}
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <div className="forself-two-inner">
                      ...
                      <ul className="two-inner1-ul">
                        ...
                        <li>
                          <div className="input-group mb-3">
                            ...
                            <input type="text" className="editDetails-input" value={phone} onChange={(e)=>setPhone(e.target.value)}/>
                            </span>
                          </div>
                        </li>
                      </ul>
                      <ul className="two-inner2-ul">
                        ...
                        <li>
                          <div className="input-group mb-3">
                            <span className="form-control">
                            <input type="text" className="editDetails-input" value={email} onChange={(e)=>setEmail(e.target.value)}/>
                            </span>
                          </div>
                        </li>
                      </ul>
                ...
                <div className="self-about-main">
                  <div className="self-about-left">
                    <ul>
                      ...
                      <li>
                        <b>
                        <input type="text" className="editDetails-input" value={motherTongue} onChange={(e)=>setMotherTongue(e.target.value)}/>
                          </b>
                      </li>
                    </ul>
                    ...
                    <ul>
                      ...
                      <li>
                        <b>
                        <input type="text" className="editDetails-input" value={maritalStatus} onChange={(e)=>setMaritalStatus(e.target.value)}/>  
                          </b>
                      </li>
                    </ul>
                    ...
                    <ul>
                      ...
                      <li>
                        <b>
                        <input type="text" className="editDetails-input" value={height} onChange={(e)=>setHeight(e.target.value)}/>  
                          </b>
                      </li>
                    </ul>
                    ...
                    <ul>
                      ...
                      <li>
                        <b>
                        <input type="text" className="editDetails-input" value={weight} onChange={(e)=>setWeight(e.target.value)}/>  
                          </b>
                      </li>
                    </ul>
                  </div>
